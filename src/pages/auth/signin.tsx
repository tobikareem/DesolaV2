      ...
      <div className="w-full p-6 h-auto flex-grow flex justify-center items-center md:p-10">
        <div className="w-full p-8  max-w-md">
          ...
          <Input
            ...
            className="text-sm mb-4 w-full rounded-xl"
          />
          ...
          <div className="relative w-full mb-8">
            <Input
              ...
              className="text-sm w-full rounded-xl mb-2"
            />
            {revealPassword ? (
              <FaEyeSlash
            ...
            <Link
              to={'/reset'}
              className="mb-8 flex justify-end font-work-sans  text-sm text-neutral-500 cursor-pointer"
            >
              Forget Password
            </Link>
          </div>
