                    ...
                    .map((faqItem: string, index: number) => {
                        ...
                        return (
                            <div
                                ...
                                className={`flex flex-col p-4 md:p-6 w-full gap-4 rounded-[24px] ${open[index] ? 'h-fit' : 'h-16 items-center'} hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer`}>
