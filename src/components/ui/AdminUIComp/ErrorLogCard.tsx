...
import { AlertTriangle, Info, XCircle, Circle } from 'lucide-react';
    ...
    >
      <div className="flex gap-3 w-full">
        ...
        <div className="flex-1">
          ...
          <Text as='h3' size='sm' weight='medium' fontStyle='font-grotesk' className="text-sm font-medium text-gray-900">{log.message}</Text>
